...
statusbar = Label(root, text="Feel the Music", relief=SUNKEN,
...
def playmusic():  # we made a func name playmusic
    ...
    if paused:
        ...
        try:
            ...
            print("Error")
            tkinter.messagebox.showerror('Error', 'You need to open a file first')  # if you press play without specifing a song
